...
declare type NativeStripeSdkType = {
    ...
    initCustomerSheet(params: CustomerSheetInitParams, customerAdapterOverrides: {
        [Property in keyof CustomerAdapter]: boolean;
    }): Promise<{
        error?: StripeError<CustomerSheetError>;
    }>;
    presentCustomerSheet(params: CustomerSheetPresentParams): Promise<CustomerSheetResult>;
    retrieveCustomerSheetPaymentOptionSelection(): Promise<CustomerSheetResult>;
    customerAdapterFetchPaymentMethodsCallback(paymentMethods: Array<object>): Promise<void>;
    ...
    customerAdapterFetchSelectedPaymentOptionCallback(paymentOption: CustomerPaymentOption | null): Promise<void>;
